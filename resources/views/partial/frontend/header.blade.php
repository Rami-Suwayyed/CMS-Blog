        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-7 col-lg-2">
                    <div class="logo">
                        <a href="index.html">
                            <img src="{{ asset('images/frontend/logo/logo.png') }}" alt="logo images">
                        </a>
                    </div>
                </div>
                                    ...
                                    <div class="single__items">
                                        <div class="miniproduct">
                                            <div class="item01 d-flex">
                                                <div class="thumb">
                                                    <a href="product-details.html"><img src="{{ asset('images/frontend/product/sm-img/1.jpg') }}" alt="product images"></a>
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="item01 d-flex mt--20">
                                                <div class="thumb">
                                                    <a href="product-details.html"><img src="{{ asset('images/frontend/product/sm-img/3.jpg') }}" alt="product images"></a>
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="item01 d-flex mt--20">
                                                <div class="thumb">
                                                    <a href="product-details.html"><img src="{{ asset('images/frontend/product/sm-img/2.jpg') }}" alt="product images"></a>
                                                </div>
                                                <div class="content">
