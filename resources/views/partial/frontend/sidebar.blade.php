<div class="wn__sidebar">
    ...
    <aside class="widget recent_widget">
        <h3 class="widget-title">{{ __('Frontend/general.recent_posts') }}</h3>
    ...
    <aside class="widget comment_widget">
        <h3 class="widget-title">{{ __('Frontend/general.comments') }}</h3>
        <ul>
            ...
            <li>
                <div class="post-wrapper">
                    ...
                    <div class="content">
                        <p>{{ $recent_comment->name }} {{ __('Frontend/general.says') }}:</p>
    ...
    <aside class="widget category_widget">
        <h3 class="widget-title">{{ __('Frontend/general.categories') }}</h3>
        <ul>
    ...
    <!-- Start Single Widget -->
    <aside class="widget category_widget">
        <h3 class="widget-title">{{ __('Frontend/general.tags') }}</h3>
        <ul>
    ...
    <aside class="widget archives_widget">
        <h3 class="widget-title">{{ __('Frontend/general.archives') }}</h3>
        <ul>
